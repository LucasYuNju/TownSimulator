...
public class ConstructTransportBTN implements ActionNode{
	...
	private void fetchResource()
	{
		...
		mConstructInfo.transportWareHouse.addCurBuildResource(mConstructInfo.transportRSType, -takeAmount);
		mConstructInfo.curRSAmount += takeAmount;
	}
	
	private void addResourceToBuilding()
	{
		mConstructInfo.proj.getBuilding().addCurBuildResource(mConstructInfo.transportRSType, mConstructInfo.curRSAmount);
	}
